...
console.log(arr1);
console.log(newLength); // push 메서드 수행 이후 변경된 배열의 길이 출력
...
// 5. slics : 마치 가위처럼, 배열의 특정 범위를 잘라내서 새로운 배열로 반환
let arr5 = [1, 2, 3, 4, 5];
let sliced = arr5.slice(2, 5); // 마지막 인덱스는 +1을 해서 넣어줘야 함
let sliced2 = arr5.slice(2); // 마지막까지 자른다면 마지막 인덱스는 안적어도 됨
